        ...
        return Vue.component("our-story-component", {
            ...
            beforeRouteEnter (to, from, next) {
                next(vm => {
                    ...
                    vm.$store.dispatch('LOAD_PAGE_DATA', {url:vm.property.mm_host + "/pages/northpark-our-story.json"}).then(response => {
            ...
            beforeRouteUpdate (to, from, next) {
                this.$store.dispatch('LOAD_PAGE_DATA', {url:this.property.mm_host + "/pages/northpark-our-story.json"}).then(response => {
