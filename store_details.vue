<template>
    <div class="page-container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <div class="row">
            <div class="col-md-12">
                <p class="page-breadcrumb">{{property.name}}&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;<breadcrumbs>{{ breadcrumb }}</breadcrumbs>&nbsp;<i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;<span v-if="currentStore && checkStoreType(currentStore.category_name)"><i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp;</span>{{currentStore.name }}</p>
            </div>
        </div>
    </div>
</template>
