          ...
          <div id="currentPost">
            ...
            <div class="blog-details-title">
              <div class="hidden-mobile">
                <social-sharing v-if="currentPost" :url="shareURL(currentPost.slug)" :title="currentPost.title" :description="currentPost.body"
                  :quote="truncate(currentPost.body)" twitter-user="NorthParkCenter" :media="currentPost.image_url" inline-template>
          ...
          <affix relative-element-selector="#currentPost">
            <div class="sidebar">
              ...
              <div class="sidebar-container">
                ...
                <p class="sidebar-newsletter-info">Subscribe to our newsletter and receive insider information on events, exclusive sales, special offers and
                  much more.</p>
                <div class="blog-newsletter-container">
                  <form action="https://mobilefringe.createsend.com/t/d/s/jhithd/" method="post">
                    ...
                    <button class="news-submit" type="submit">
