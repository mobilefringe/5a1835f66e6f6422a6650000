    ...
    <div> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <div class="page-container">
            ...
            <paginate name="currentSelection" v-if="currentSelection" :list="currentSelection" class="paginate-list margin-60">
                <div class="row details-promo-container" v-for="(blog, index) in paginated('currentSelection')" v-if="currentSelection" :class="{ 'last': index === (paginated('currentSelection').length - 1) }">
