    ...
    <div v-if="dataLoaded" v-cloak>
      ...
      <div class="page-container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="sidebar">
              <p class="quote">Every company has a special responsibility to enrich the lives of its customers and the community. It should
                serve as a catalyst to link art and business for the benefit of all.</p>
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-md-pull-8">
            <div class="sidebar-left">
              <p class="quote">THE 50TH ANNIVERSARY OF NORTHPARK CENTER LOREM IPSUM DOLOR SIT AMET, CONSECTETUER ADIPISCING ELIT, SED DIAM NONUMMY
                NIBH EUISMOD TINCIDUNT UT LAOREET DOLORE MAGNA AL.</p>
