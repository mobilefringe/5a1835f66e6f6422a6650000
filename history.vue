<template>
    <div class="page-container"> <!-- for some reason if you do not put an outer container div this component template will not render -->
        ...
        <div class="row">
            <div class="col-md-12">
                <slick ref="slick" :options="slickOptions">
                    <div v-for="banner in historyBanners" v-if="historyBanners">
                        ...
                        <h5 class="details-banner-title">{{ banner.name }}</h5>
                    </div>
                </slick>
            </div>
            <div class="col-md-8">
            ...
            <div class="col-md-4">
                <div class="sidebar">
                    <p class="quote">Every company has a special responsibility to enrish the lives of its customers and the community. It should serve as a catalyst to link art and business for the benefr of all.</p>
